...
const experiences = [
  {
    ...
    isPresent: true,
    description:
      "Developing and scaling modern full stack web applications using React.js, Node.js, and cloud services. Building responsive frontends and resilient backend APIs.",
    tags: ["React.js", "Node.js", "Express.js", "MongoDB", "Cloud"],
  },
  {
    id: 2,
    ...
    isPresent: false,
    description:
      "Assisted in building full-stack web applications using React.js and Node.js. Developed clean UIs, integrated RESTful APIs, and maintained database schema logic.",
